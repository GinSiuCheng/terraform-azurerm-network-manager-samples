...
for vm in $vm_list; do
    echo "Starting $vm..."
    az vm start --name $vm --resource-group $resourceGroup --subscription $subscriptionId --no-wait
done

echo "All virtual machines in resource group $resourceGroup have been started."